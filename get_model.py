...
def get_model(weights_path = None):
    """
    Method for getting model with loaded weights. There are may be issues if one python run uses function twice or more
    """
    ...
    # Builing model and loading weights if available
